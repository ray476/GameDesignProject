...
namespace template_test
{
    ...
    class Level_Generator_Keystone
    {
        ContentManager content;
        private int starting_density = 20;
        ...
        public Level_Generator_Keystone(ContentManager manager, Camera camera, AbsAvatarObject avatar, AudioManager audio)
        {
            content = manager;
        ...
        private ItemObject Select_Item(List<AbsObject> absObjects)
        {
            ItemObject result;
            Random random_generator = new Random(DateTime.Now.Millisecond);
            double odds = random_generator.Next(0,2);
            if (odds == 0)
            {
        ...
        private Vector2 Find_Location(List<AbsObject> absObjects)
        {
            ...
            result.Y = random_generator.Next((int)(camera_position.Y - screen_dimensions.Y), (int)(camera_position.Y));
            if(result.Y > 3500)
            {
